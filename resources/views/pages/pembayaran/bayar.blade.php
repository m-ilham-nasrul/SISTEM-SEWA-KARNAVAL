...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Pembayaran: {{ $pengembalian->penyewa->nama_penyewa ?? '-' }}</h1>
        </div>
                ...
                <div class="card shadow border-left-primary mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-md-9">
                                {{ $pengembalian->penyewa->nama_penyewa ?? 'Penyewa sudah dihapus' }}
                            </div>
                        </div>
                        ...
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-md-9">
                                @forelse($pengembalian->kostum_list as $kostum)
                                    {{ $kostum->nama_kostum }}@if (!$loop->last),@endif
                                @empty
                        ...
                        <form action="{{ route('pengembalian.update', $pengembalian->id) }}" method="POST">
                            ...
                            <div class="mb-3" id="input_ewallet_nama" style="display:none;">
                                ...
                                <input type="text" name="nama_ewallet" class="form-control"
                                       value="{{ old('nama_ewallet', $pengembalian->nama_ewallet) }}" placeholder="DANA / OVO / Gopay">
                            </div>
                        ...
                        <div class="row">
                            ...
                            @if ($totalFoto > 4)
                                <div class="col-12 text-center mt-3">
                                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalSemuaFoto">
